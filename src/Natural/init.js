    ...
    import("../Resources/DB")
        .then(async (DB) => {
            try {
                ...
                let noChangeTree = deepEqual(appSession.tree.data, await ImportManager.getTreeDataFromQuery(appSession.tree.seed))
                if (!noChangeTree) console.log("!!! The seed document file has changed from the last session. Perhaps you want to regrow the tree.")
