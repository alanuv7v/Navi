...
export const Tabs = (contents) => {
    for (let v of Object.values(contents)) v.style.display = "none"
    let toShow = Object.values(contents)[0]
    toShow.style.display = "block"
    return div({class: "tabs"},
        div({class: "tabButtons"},
            Object.keys(contents).map(key => button({class: "tabButton", 
                onclick: () => {
